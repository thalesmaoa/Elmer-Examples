...
renderView1.Set(
    ViewSize=[1452, 808],
    InteractionMode='2D',
    CameraPosition=[0.0, 0.0, 0.9380000000000002],
    CameraFocalDisk=1.0,
    CameraParallelScale=0.08163879084155314,
...
resultspvd = PVDReader(registrationName='results.pvd', FileName='./sim/result/paraview/results.pvd')
resultspvd.Set(
...
import os
SaveScreenshot(os.path.abspath("./sim/plots/cena_paraview.png"))
